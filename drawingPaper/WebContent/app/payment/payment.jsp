...
<body style="height:2000px">
	...
	<input name="" type="hidden" valeu=""><!-- project_name -->
	<input name="pay_price" type="text" valeu=""><!-- pay_price  -->
	<input name="" type="hidden" valeu=""><!-- user_email -->
	<input name="" type="hidden" valeu=""><!-- user_name -->
	<input name="" type="hidden" valeu=""><!-- user_tel -->
