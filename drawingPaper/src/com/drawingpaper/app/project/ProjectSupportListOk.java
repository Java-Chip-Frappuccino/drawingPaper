...
public class ProjectSupportListOk  implements Action{
	...
	public ActionForward execute(HttpServletRequest req, HttpServletResponse resp) throws Exception{
		...
		//전체 프로젝트 수 //////////다르게 뿌리기
		int total = dao.getSupportProjectTotal();
		//사용자가 요청한 페이지
		...
		req.setAttribute("supportProjectList", dao.selectSupportProject(projectMap));
