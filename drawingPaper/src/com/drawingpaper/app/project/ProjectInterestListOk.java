...
public class ProjectInterestListOk  implements Action{
	...
	public ActionForward execute(HttpServletRequest req, HttpServletResponse resp) throws Exception{
		...
		//전체 프로젝트 수 //////////다르게 뿌리기
		int total = dao.getInterestProjectTotal();
		//사용자가 요청한 페이지
		...
		req.setAttribute("InterestProjectList", dao.selectInterestProject(projectMap));
		...
		//내 프로젝트, 관심 프로젝트, 후원한 프로젝트 구분할 방법 고민
