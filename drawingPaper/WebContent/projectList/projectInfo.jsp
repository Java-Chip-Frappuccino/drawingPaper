...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="../css/projectInfo.css" />
    <style>
                ...
                <div class="top_info">
                    ...
                    <div>
                        <div class="info_titel">
                            ...
                            <div><img src="" alt=""><span>주식회사 켈빈클레인프로젝트</span></div>
                        </div>
                    </div>
                    <div class="top_img">
                        <img src="/assets/image/bg/indi05.webp" alt="">
                    </div>
                    <aside class="info_data">
                        ...
                        <div class="dataCell3">
                            <div>
                                <button>
                                    <div>
                                        <img src="/assets/image/icon/icon_heart_1.svg" alt="">
                                    </div>
                            ...
                            <div>
                                <button>
                                    <div>
                                        <img src="/assets/image/icon/icon-link.png" alt="">
                                    </div>
                                    <div class="btnLabl">하트</div>
                                </button>
                            </div>
                            <div><button>이 프로젝트 후원하기</button></div>
                        </div>
                    </aside>
                </div>
            </section>
